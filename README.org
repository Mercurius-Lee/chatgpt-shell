...
(use-package shell-maker
  :straight (:host github :repo "xenodium/chatgpt-shell" :local-repo "chatgpt-shell" :files ("shell*.el")))

(use-package chatgpt-shell
  :straight (:host github :repo "xenodium/chatgpt-shell" :local-repo "chatgpt-shell" :files (:defaults (:exclude "shell*.el")))
  :config
